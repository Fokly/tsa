...
export const Contact = () => {
  ...
  return (
    ...
    <div className="formContainer">
        <motion.div className="phonesvg" initial={{opacity:1}} animate={isInView && {opacity:0}} transition={{delay:1, duration:1}}>
        <svg width="500px" height="500px" viewBox="0 0 32.666 32.666">
            <motion.path strokeWidth={0.2} fill="none" initial={{pathLenght:0}} whileInView={{pathLenght:1}} transition={{duration:2}}/>
